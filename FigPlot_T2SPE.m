function FigPlot_PCA(T1,FaultID,Bias,TankNum,IndX,lim,ts1,TS,SPE,S1,Dtest,e)
...
if T1 == 4
        ...
        filename3 = "FaultyVect_" + num2str(T1) + "T_t" + num2str(TankNum) + "_" + FaultID + "-" + num2str(Bias) + "_" + string(datetime('now'),'yy-MM-dd_HH_mm_ss')+".png";
        saveas(gcf,filename3); 
